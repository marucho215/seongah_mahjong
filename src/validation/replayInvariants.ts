import type { GameEvent, HandStartEvent } from "../core/GameLog.js";
import { nextSeat, seatDistance } from "../core/seats.js";
 ...
 *
 * Moved here from tests/helpers/replayQa.ts (unchanged) so it can be reused by both the
 * test suite and the validation harness's CLI script (src/sim/*), which lives under src/
 * and therefore can't import from tests/. tests/helpers/replayQa.ts now re-exports this.
 */
